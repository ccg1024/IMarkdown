...
import { defaultAppDirectory, closeMessage } from './window/tools'
import { FileCache } from './window/menu/menu-callback'
import { mountIPC } from './window/ipc'
import { getFileCacheProxyHandler } from './window/proxy'
